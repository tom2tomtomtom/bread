...
import { LayoutVariation, ExportConfiguration, ChannelFormat, ChannelSpecs } from '../types';
...
class ExportService {
   ...
   */
  async exportLayout(layout: LayoutVariation, config: ExportConfiguration): Promise<ExportResult> {
  ...
  async exportProject(
    ...
    // Create project ZIP
    const downloadUrl = await this.createProjectDownload(
