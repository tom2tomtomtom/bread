...
export const ConfidenceDisplay: React.FC<ConfidenceDisplayProps> = ({
  ...
  if (!showDetails) {
    ...
    return (
      <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-bold ${getConfidenceColor(averageConfidence)}`}>
    ...
    <div className="bg-black/10 p-3 rounded-xl mb-4">
      ...
      <div className="mb-2">
        <div className="flex justify-between items-center mb-1">
          ...
          <span className={`text-xs font-bold px-2 py-0.5 rounded ${getConfidenceColor(confidence.marketFit)}`}>
      ...
      <div className="mb-2">
        <div className="flex justify-between items-center mb-1">
          ...
          <span className={`text-xs font-bold px-2 py-0.5 rounded ${getConfidenceColor(confidence.complianceConfidence)}`}>
      ...
      <div className="mb-3">
        <div className="flex justify-between items-center mb-1">
          ...
          <span className={`text-xs font-bold px-2 py-0.5 rounded ${getConfidenceColor(confidence.audienceResonance)}`}>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className={`px-2 py-1 rounded-full text-xs font-bold border ${getRiskLevelStyle(confidence.riskLevel)}`}>
