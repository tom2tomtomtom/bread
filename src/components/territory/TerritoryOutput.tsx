  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold text-white mb-2">Generated Territories</h2>
          <p className="text-gray-300">
            {generatedOutput.territories.length} territories with{' '}
            {generatedOutput.overallConfidence}% overall confidence
          </p>
        </div>
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
        <div className="flex items-center justify-between">
          ...
          <div
            className={`text-4xl font-bold px-6 py-3 rounded-2xl ${
      ...
      {/* Export Manager */}
      <ExportManager generatedOutput={generatedOutput} onShowToast={onShowToast} />
      ...
      {generatedOutput.compliance && (
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
          ...
          <div className="space-y-4">
            ...
            {generatedOutput.compliance.powerBy &&
              generatedOutput.compliance.powerBy.length > 0 && (
                <div>
