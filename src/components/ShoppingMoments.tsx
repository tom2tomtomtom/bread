  ...
  return (
    <div className="mb-8">
      ...
      <p className="text-sm text-gray-400 mb-4">
        Click any moment to populate your brief field with a complete campaign brief
      </p>
